    ...
    <>
      ...
      <main>
        <div className="flex flex-col justify-center items-center gap-10 py-8">
          <div id="centerBox" className="fixed w-5 h-5 top-[50%] left-[54%] md:left-[50%] bg-black z-10 opacity-0" />
          ...
          <div className="w-full px-4 md:max-w-7xl md:justify-start flex flex-row flex-wrap gap-4 justify-center items-start">
            {/* column 1 */}
            <div className="flex-col gap-4 flex-center md:flex">
              {column_1.map(col1 => (
                ...
                items-center left-[24rem] md:left-[23rem] text-2xl bg-red-400 cursor-pointer scale-50 rounded-md"
